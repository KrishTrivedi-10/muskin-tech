    ...
    <div className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
      <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
        ...
        <p className="text-gray-500 text-lg mb-10">
          Ready to hire top talent or find your next role? Reach out to Muskin Career Solutions today.
        </p>
      ...
      <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.2 }}>
        <form action="https://formspree.io/f/xbdplonb" method="POST" className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 space-y-5">
          <div>
